...
import com.guvenfuture.onedosehealth.omron.constants.Constants
import com.guvenfuture.onedosehealth.omron.constants.OmronDevices
...
class OmronOperators(private val context: Context) {
    ...
    fun startOmronPeripheralManager(isHistoricDataRead: Boolean, hashId: String) {
        ...
        var deviceSettings: java.util.ArrayList<HashMap<*, *>?>? = java.util.ArrayList()
