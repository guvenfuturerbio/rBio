...
class S implements WidgetsLocalizations {
  ...
  String get btn_sign_in_facebook => "Quick Appointment";
  ...
  String get gender_sercet => "SECRET";
  ...
  String get title_intro3 => "Appointment";
  ...
  String get wrong_username_password => "Wrong Username or Password!";
  String get warning => "Warning";
  String get sorry_dont_transaction => "Sorry, we are currently unable to complete your transaction. Please try again later";
  String get tc_or_passport => "T.C identity/Passport Number";
  String get tc_or_pass_cannot_empty =>"Username or password cannot be empty !";
  String get citizen_of_tc => "Citizen of T.C";
  String get foreign_national => "Foreign National";
  String get tc_identity_number => "T.C identity Number";
  ...
  String get sms_verification_code => "Sms Verification Code";
  String get password_again => "Password Again";
  String get wrong_or_expired_sms => "The sms verification code may have expired or you entered an incorrect code";
