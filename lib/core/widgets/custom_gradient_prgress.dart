...
class CustomGradientProgress extends StatefulWidget {
  ...
  @override
  _CustomGradientProgressState createState() => _CustomGradientProgressState();
}

class _CustomGradientProgressState extends State<CustomGradientProgress>
  ...
  @override
  void didUpdateWidget(CustomGradientProgress oldWidget) {
  ...
  Widget _buildIndicator(BuildContext context, double animationValue) {
    return Container(
      ...
      decoration: BoxDecoration(
          borderRadius: widget.isCircle ? BorderRadius.circular(200) : null,
