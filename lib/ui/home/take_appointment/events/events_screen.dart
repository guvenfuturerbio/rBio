...
class _EventsScreenState extends State<EventsScreen> {
        ...
        child: Column(
          ...
          children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    TableCalendar(
                        ...
                        headerStyle: HeaderStyle(
                          rightChevronIcon: new Icon(Icons.chevron_right,
                              color: R.color.white),
                          leftChevronIcon: new Icon(Icons.chevron_left,
                              color: R.color.white),
                        ...
                        availableCalendarFormats: {
                          CalendarFormat.twoWeeks:
                              LocaleProvider.of(context).two_week,
                          CalendarFormat.month:
                              LocaleProvider.of(context).month,
            ...
            value.progress == LoadingProgress.DONE
                ? value.closestAppointments.isNotEmpty
                    ? Column(
                        children: [
                          Text(
                              ...
                              children: [
                                Expanded(
                                  child: Column(
                                      ...
                                      children: List.generate(
                                          value.ayranciSlots.length, (index) {
                                                  ...
                                                  queryParameters: {
                                                    ...
                                                    'doctorName':
                                                        Uri.encodeFull(
                                                            widget.doctorName),
                                                    'departmentName':
                                                        Uri.encodeFull(widget
                                                            .departmentName),
                                                    'from': value
                                                        .ayranciSlots[index]
                                                        .from,
                                                    'to': value
                                                        .ayranciSlots[index].to,
                                                    'forOnline': 'false',
                                ...
                                Expanded(
                                  child: Column(
                                      mainAxisSize: MainAxisSize.min,
                                      children: List.generate(
                                          value.cayyoluSlots.length, (index) {
                                        return _buttonAppointment(
                                            text:
                                                value.cayyoluSlots[index].from,
                                            color: R.color.cayyolu,
                                            title: "Çayyolu",
                                            onPressed: () {
                                              Atom.to(
                                ...
                                Expanded(
                                  child: Column(
                                      mainAxisSize: MainAxisSize.min,
                                      children: List.generate(
                                          value.onlineSlots.length, (index) {
                                        return _buttonAppointment(
                                ...
                                : Column(
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                            color: R.color.blue, fontSize: 18),
                                      )
                                    ],
                                  ),
                          )
                : value.progress == LoadingProgress.LOADING
                    ? Container(
                        margin: EdgeInsets.all(16), child: loadingDialog())
                    : Container(),
          ],
        ),
      ),
  ...
  Widget closestAppointments(
      {ClosestAppointment closestAppointment, Function onPressed}) {
