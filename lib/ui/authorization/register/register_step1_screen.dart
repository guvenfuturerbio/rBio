...
class _RegisterStep1ScreenState extends State<RegisterStep1Screen> {
  ...
  final MaskedTextController _tcPhoneNumber =
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return ListTile(
                                onTap: () {
                                  setState(() {
                                    country = vm.countryList.countries[index];
                                  });
                                  Navigator.pop(context);
                                },
                                title:
                                    Text(vm.countryList.countries[index].name));
                          },
                        ),
                      ),
                    );
                        ...
                        onTap: () {
                          if (kIsWeb) {
                            ...
                            Atom.to(
                              ...
                              queryParameters: {
                                'url': Uri.encodeFull(
                                    LocaleProvider.of(context).policy_url),
