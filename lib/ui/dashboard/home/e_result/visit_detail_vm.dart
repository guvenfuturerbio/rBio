...
class VisitDetailScreenVm extends ChangeNotifier {
  ...
  int _countOfLaboratoryResults,
      _countOfPathologyResults,
      _countOfRadiologyResults;
  ...
  VisitDetailScreenVm({
    ...
    this._countOfLaboratoryResults = countOfLaboratoryResults;
    this._countOfPathologyResults = countOfPathologyResults;
    this._countOfRadiologyResults = countOfRadiologyResults;
