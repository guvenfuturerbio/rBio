  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          "${LocaleProvider.current.mediminder_details}",
          style: TextStyle(
            color: Colors.black,
            fontSize: 18,
          ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TextButton(
                    ...
                    child: Center(
                      child: Text(
                        "${LocaleProvider.current.mediminder_delete}",
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 22,
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Center(
                      child: Text(
                        "${LocaleProvider.current.mediminder_delete_approv}",
  ...
  Widget build(BuildContext context) {
    return Container(
      child: ListView(
        ...
        children: <Widget>[
          ExtendedInfoTab(
            fieldTitle: "${LocaleProvider.current.medicine_type}",
            fieldInfo: medicine.medicineType == "None"
                ? "${LocaleProvider.current.not_specified}"
                : medicine.medicineType,
          ),
          ExtendedInfoTab(
            fieldTitle: "${LocaleProvider.current.dose_interval}",
            fieldInfo: "${LocaleProvider.current.every} " +
                medicine.interval.toString() +
                " ${LocaleProvider.current.hour}  | " +
                " ${medicine.interval == 24 ? "${LocaleProvider.current.one_time_a_day}" : (24 / medicine.interval).floor().toString() + " ${LocaleProvider.current.piece}/${LocaleProvider.current.day}"}",
          ),
          ExtendedInfoTab(
              fieldTitle: "${LocaleProvider.current.start_time}",
