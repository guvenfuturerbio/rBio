...
class _BpLineChart extends StatefulWidget {
  const _BpLineChart({Key? key}) : super(key: key);

  @override
  __BpLineChartState createState() => __BpLineChartState();
}

class __BpLineChartState extends State<_BpLineChart> {
  List<ChartData> sys = [];
  List<ChartData> dia = [];
  ...
  Widget build(BuildContext context) {
    return Consumer<BpPatientDetailVm>(builder: (_, val, __) {
  ...
  SfCartesianChart _buildChartBody(BpPatientDetailVm val) {
