...
class BgPatientDetailVm extends RbioVm with IBaseBottomActionsOfGraph {
  @override
  ...
  Future<void> getNewItems(BuildContext context) async {
    await Provider.of<BgMeasurementsNotifierDoc>(
      mContext,
      listen: false,
    ).getMoreData(
      context,
      patientId: patientDetail.id!,
      date: bgMeasurements.last.date,
    );
    filterDatas();
  }
  ...
  Future<void> fetchBgMeasurements() async {
    ...
    bgMeasurements = Provider.of<BgMeasurementsNotifierDoc>(
      mContext,
      listen: false,
    ).bgMeasurements;
    notifyListeners();
  ...
  void showFilter(BuildContext context) {
    Atom.show(
      ChangeNotifierProvider<BgPatientDetailVm>.value(
        value: this,
        child: _ChartFilter(
