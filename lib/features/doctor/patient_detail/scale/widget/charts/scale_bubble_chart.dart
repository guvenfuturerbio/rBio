...
class _ScaleBubbleChart extends StatefulWidget {
  ...
  @override
  __ScaleBubbleChartState createState() =>
      __ScaleBubbleChartState();
}

class __ScaleBubbleChartState
    extends State<_ScaleBubbleChart> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ScalePatientDetailVm>(builder: (context, value, child) {
