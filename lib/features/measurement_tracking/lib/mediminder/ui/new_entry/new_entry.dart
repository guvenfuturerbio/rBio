  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          "${LocaleProvider.current.mediminder_add_new}",
          style: TextStyle(
            color: Colors.black,
            fontSize: 18,
          ),
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          MedicineTypeColumn(
                              ...
                              name:
                                  "${LocaleProvider.current.medicine_type_bottle}",
                              iconValue: 0xe900,
                          ...
                          MedicineTypeColumn(
                              ...
                              name:
                                  "${LocaleProvider.current.medicine_type_pill}",
                              iconValue: 0xe901,
                          ...
                          MedicineTypeColumn(
                              ...
                              name:
                                  "${LocaleProvider.current.medicine_type_syringe}",
                              iconValue: 0xe902,
                          ...
                          MedicineTypeColumn(
                              ...
                              name:
                                  "${LocaleProvider.current.medicine_type_tablet}",
                              iconValue: 0xe903,
      ...
      (EntryError error) {
        switch (error) {
          case EntryError.NameNull:
            displayError("${LocaleProvider.current.error_empty_medicine_name}");
            break;
          case EntryError.NameDuplicate:
            displayError("${LocaleProvider.current.error_exist_medicine_name}");
            break;
          case EntryError.Dosage:
            displayError("${LocaleProvider.current.error_empty_dosage_name}");
            break;
          case EntryError.Interval:
            displayError("${LocaleProvider.current.error_empty_time_interval}");
            break;
          case EntryError.StartTime:
            displayError("${LocaleProvider.current.error_empty_starting_time}");
            break;
          default:
        }
      },
