      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: R.color.defaultBlue,
              hint: _selected == 0
                  ? Text(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? R.color.defaultBlue : Colors.white,
            ),
            child: Center(
              child: Padding(
                ...
                child: Icon(
                  ...
                  size: 75,
                  color: isSelected ? Colors.white : R.color.defaultBlue,
                ),
              ),
            ),
          ),
          Padding(
            ...
            child: Container(
              ...
              height: 30,
              decoration: BoxDecoration(
                color: isSelected ? R.color.defaultBlue : Colors.transparent,
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14, color: R.color.defaultBlue),
          ),
        ]),
      ),
    );
