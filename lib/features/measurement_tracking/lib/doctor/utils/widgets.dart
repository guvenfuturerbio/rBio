...
TableCalendar tableCalendar(
  ...
  return TableCalendar(
      ...
      calendarStyle: CalendarStyle(
          ...
          todayStyle: TextStyle(
              fontWeight: FontWeight.bold, color: R.color.regularBlue)),
      headerStyle: HeaderStyle(
        rightChevronIcon: new Icon(Icons.chevron_right, color: R.color.white),
        leftChevronIcon: new Icon(Icons.chevron_left, color: R.color.white),
        titleTextStyle: TextStyle(color: R.color.white),
...
Widget patientInfo(
    {BuildContext context, Patient patient, Function onPressed}) {
  return InkWell(
    onTap: () {
...
Widget hypo({BuildContext context, int width, int height, Patient patient}) {
  return Container(
    alignment: Alignment.center,
...
Widget hyper({BuildContext context, int width, int height, Patient patient}) {
  return Container(
    alignment: Alignment.center,
    width: width ?? MediaQuery.of(context).size.width * 0.15,
    height: height ?? MediaQuery.of(context).size.width * 0.15,
...
Widget measurementBox(
    {BuildContext context, int width, int height, Patient patient}) {
  return Container(
    alignment: Alignment.center,
    width: width ?? MediaQuery.of(context).size.width * 0.15,
    height: height ?? MediaQuery.of(context).size.width * 0.15,
...
List<Widget> _buildRowList2(List<String> states, BuildContext context) {
  List<Widget> generatedList = [];
  for (int i = 0; i < states.length; i++) {
    generatedList.add(Consumer<PatientDetailPageViewModel>(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: i == 0 ? Colors.transparent : R.color.stateColor,
                    border: Border.all(
                      color: R.color.stateColor,
                      width: 2.0,
                    ),
                  ),
                ),
...
List<Widget> _buildRowList(Map<Color, String> values, BuildContext context) {
  List<Widget> generatedList = [];
