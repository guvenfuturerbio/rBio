...
class ChangeToDefaultFromRelativeSuccessEvent extends BaseEvent {
  ChangeToDefaultFromRelativeSuccessEvent() : super("yakinlarimAnaHesapGecis_Basarili", null);
}
...
class DeleteRelativeSuccessEvent extends BaseEvent {
  DeleteRelativeSuccessEvent(String relativeNameAndSurname) : super("yakinSilme_Basarili", {
    'yakin_ismi': relativeNameAndSurname
  });
}

class YoutubeSurveyCompleteEvent extends BaseEvent {
  YoutubeSurveyCompleteEvent({String name, String surname, String phone, String courseId}) : super("youtubeAnket_Tamamlandi", {
    'isim': name,
    'soyisim': surname,
    'telefon': phone,
    'egitim': courseId
...
class YoutubeSurveySkipEvent extends BaseEvent {
  YoutubeSurveySkipEvent({String courseId}) : super("youtubeAnket_Atlandi", {
    'egitim': courseId
  });
}