...
class BgProgressPageViewModel
  ...
  BgProgressPageViewModel({required BuildContext context}) {
  ...
  Widget get currentGraph => _currentGraph ?? const AnimationScatterDefault();

  void setCurrentGraph() {
    currentGraphType == GraphType.bubble
        ? _currentGraph = const AnimationScatterDefault()
        : _currentGraph = const AnimationLineDefault();
    notifyListeners();
  }
