...
class ScaleSmallScatter extends SampleView {
  final Function() callBack;

  ScaleSmallScatter(this.callBack) : super(callBack: callBack);

  /// Creates the Scatter chart sample with dynamically updated data points.
  @override
  _ScaleSmallScatterState createState() => _ScaleSmallScatterState();
}

class _ScaleSmallScatterState extends SampleViewState {
  ...
  Widget build(BuildContext context) {
    return Consumer<ScaleProgressPageViewModel>(
      ...
      return HomeCard(
        child: _getAnimationScatterChart(),
