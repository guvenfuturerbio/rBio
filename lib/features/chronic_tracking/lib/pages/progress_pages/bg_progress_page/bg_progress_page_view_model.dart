...
import '../../../widgets/charts/bubble/animated_bubble_chart.dart';
import '../../../widgets/charts/bubble/small_bubble/small_glucose_scatter.dart';
import '../../../widgets/charts/line/animated_line_chart.dart';
...
class BgProgressPageViewModel with ChangeNotifier implements ProgressPage {
  ...
  Future<void> fetchBgMeasurements() async {
    final result = await BgMeasurementsNotifier().fetchBgMeasurements();
    this.bgMeasurements = BgMeasurementsNotifier().bgMeasurements;
    notifyListeners();
  }
  ...
  Widget smallWidget(Function() callBack) {
    return BgSmallScatterDefault(callBack);
  }
