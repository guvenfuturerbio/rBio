    ...
    return Consumer<CreateAppointmentVm>(
      builder: (
        ...
        Widget child,
          ...
          val.progress == LoadingProgress.LOADING
              ? Center(child: CircularProgressIndicator())
              : Scaffold(
                  appBar: RbioAppBar(
                    title: RbioAppBar.textTitle(context, "Randevu Oluştur"),
                  ),
                  body: Padding(
                          ...
                          child: AnimatedOpacity(
                            ...
                            child: val.departmentProgress ==
                                ...
                                : CreateAppoWidget(
                                    ...
                                    itemList:
                                        val.filterDepartmentResponse == null
                                            ? []
                          ...
                          child: AnimatedOpacity(
                            ...
                            child: val.doctorProgress == LoadingProgress.LOADING
                                ...
                                : CreateAppoWidget(
                                    ...
                                    itemList:
                                        val.filterResourcesResponse == null
                                            ? []
                            ...
                            child: Center(
                              child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                    fixedSize: Size(
                                        Atom.width * .65, Atom.height * .05),
                                    primary: getIt<ITheme>().mainColor,
                                    shape: RoundedRectangleBorder(
                                        borderRadius:
                                            BorderRadius.circular(50))),
                                onPressed: val.departmentSelected &&
