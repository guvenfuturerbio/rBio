...
class BloodGlucoseValueDetail {
  ...
  factory BloodGlucoseValueDetail.fromJson(Map<String, dynamic> json) =>
      _$BloodGlucoseValueDetailFromJson(json);

  Map<String, dynamic> toJson() => _$BloodGlucoseValueDetailToJson(this);

  @override
  String toString() => 'BloodGlucoseValueDetail(time: $time, tag: $tag)';
}
